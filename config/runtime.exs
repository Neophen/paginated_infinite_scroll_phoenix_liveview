...
#
#     PHX_SERVER=true bin/paginated_infinite_scroll_phoenix_liveview start
#
...
if config_env() == :prod do
  ...
  #
  #     config :paginated_infinite_scroll_phoenix_liveview, PaginatedInfiniteScrollPhoenixLiveviewWeb.Endpoint,
  #       https: [
  #         ...,
  #         port: 443,
  #         cipher_suite: :strong,
